---
description: Wrap session and update agent docs
---

You are wrapping up work and updating `agent-docs/` for the next session. The context files were auto-loaded at session start; do not re-read them unless you need to validate changes.
