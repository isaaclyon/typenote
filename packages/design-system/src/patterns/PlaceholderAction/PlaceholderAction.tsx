...
export interface PlaceholderActionProps {
  ...
  disabled?: boolean;
  /** Whether to show icon-only mode (useful for collapsed sidebars) */
  collapsed?: boolean;
    ...
    return (
      <Tooltip content={label} side="right">
        <button
          ...
          aria-label={label}
          className={cn(
            'flex h-7 w-full items-center justify-center rounded-md border border-dashed',
